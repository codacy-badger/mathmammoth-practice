...
<html lang="en-US">
  <head>
    ...
    <title>Addition Hidden Picture Game &mdash; Online Practice (1st, 2nd, 3rd, and 4th grade)</title>
    <style>
      .flex-container {
        width: 800px;
        max-width: 100%;
    ...
    <div class="container">
      <div class="jumbotron" id="form" style="background-color: #a5eaff">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <section class="go p-3 mb-5 shadow-lg" style="border-radius: 15px; box-shadow: 0 1rem 3rem rgba(0,0,0,.4) !important; background-color: #8cff90">
                <label for="rand-range" class="text-center d-block font-weight-bold">Range for numbers to be added:</label>
        ...
        <section class="text-center">
          ...
          <p><a href="javascript:location.href='/practice/mystery-picture#min=2&max=50';location.reload();">3rd grade (Min: 2, Max: 50)</a></p>
          <p><a href="javascript:location.href='/practice/mystery-picture#min=2&max=100';location.reload();">4th grade (Min: 2, Max: 100)</a></p>
          <p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <label for="gen-range" class="font-weight-bold">Range of numbers to be added:</label>
            <div id="gen-range">
              <div class="form-group form-inline d-inline-block">
                <label for="gen-min" class="d-inline">Min:</label>
                <input type="number" id="gen-min" class="form-control" value="9">
              </div><br />
              <div class="form-group form-inline d-inline-block">
                <label for="gen-max" class="d-inline">Max:</label>
                <input type="number" id="gen-max" value="20" class="form-control">
              </div>
            </div>
    ...
    <script>
      ...
      document.querySelector('.go-btn').addEventListener('click', function() {
        ...
        for (var i = 0; i < 12; i++) {
          ...
          while (questions.map(function(item) { return item[1]; }).indexOf(rand1 + rand2) > -1) {
            rand1 = rand(min, max);
            rand2 = rand(min, max);
          }
          var question = [rand1 + ' + ' + (rand2 < 0 ? '(' + rand2 + ')' : rand2), rand1 + rand2];
      ...
      $('.gen-link-btn').click(function() {
        var link = 'https://www.mathmammoth.com/practice/mystery-picture#min=' + $('#gen-min').val() + '&max=' + $('#gen-max').val();
        ...
        var shareHTML = `<a class="gen-share-btn" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=${encoded}&display=popup&src=share_button" title="Facebook">
...
<a class="gen-share-btn" target="_blank" href="https://twitter.com/intent/tweet?text=${encoded}" title="Twitter">
...
<a class="gen-share-btn" target="_blank" href="http://www.tumblr.com/share/link?url=${encoded}" title="Tumblr">
...
<a class="gen-share-btn" target="_blank" href="sms:${smsChar}body=${encoded}" id="sms" title="SMS">
...
<a class="gen-share-btn" target="_blank" href="https://wa.me/?text=${encoded}" title="WhatsApp">
...
<a class="gen-share-btn" href="mailto:?body=${encoded}" title="Email">
