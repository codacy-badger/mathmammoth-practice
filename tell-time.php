...
<head>
  ...
  <meta property="og:description" content="Here you can practice telling time on an analog clock. You can choose from many options below, such as telling time to the whole hours, whole and half hours, quarter hours, to the minute, and so on. 🕢 This way you can make the practice sessions easier or harder, depending on your student's grade level.">
  <meta property="og:image" content="https://www.mathmammoth.com/practice/telling-time.png">
  <meta property="og:image:secure_url" content="https://www.mathmammoth.com/practice/telling-time.png" />
  <meta property="og:image:type" content="image/png" />
  <meta property="og:image:width" content="684" />
  <meta property="og:image:height" content="637" />
  <meta property="og:image:alt" content="Telling Time 🕤" />
  <meta property="og:url" content="https://www.mathmammoth.com/practice/tell-time">
  <meta property="og:site_name" content="Math Mammoth Practice">
  <meta property="og:locale" content="en_US" />
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:image:alt" content="Telling Time 🕤">
  <title>Telling Time 🕤 &mdash; Online Practice (grades K-3)</title>
  <style>
    .clock {
      width: 200px;
      margin: auto;
...
<body>
  <?php $page = 'telling-time'; include 'header.php'; ?>
  <div class="container">
    <div class="jumbotron" id="form" style="background-color: #a5eaff">
      <h1 class="text-center">
        Telling Time 🕓<br>
        <span style="font-size: 1.5rem">Online practice for grades K-3</span>
      </h1>
      <div class="addthis_inline_share_toolbox"></div>
      <div class="row">
        <div class="col-lg-6">
          <p>Here you can practice telling time on an analog clock. You can choose from many options below, such as telling time to the whole hours, whole and half hours, quarter hours, to the minute, and so on. 🕢 This way you can make the practice sessions easier or harder, depending on your student's grade level.</p>

          <p>For kindergarten and first grade, choose whole hours. First graders can also tell time to the half hour. In second grade, children should learn to tell time to the quarter hours and to the nearest five minutes, and then in third grade, to the minute.</p>

          <label for="time-opts" class="mt-3 font-weight-bold">The time given can be:</label>
          <div id="time-opts">
        ...
        <div class="col-lg-6">
          <p>
            Screenshot:<br />
            <img src="telling-time.png" class="rounded-lg screenshot" alt="Screenshot of someone doing a round">
          </p>
        </div>
      </div>
    ...
    <div class="jumbotron d-none" id="questionbox" style="background-color: #a5eaff; text-align: center;">
      ...
      <div id="numq" class="text-center" style="font-weight: bold">What time is it?</div>
      <div class="clock">
      ...
      <div class="responses">
        <div class="response form-inline">
          <input type="number" id="res-hours" class="form-control" value="00">
        </div>
        <div class="colon">:</div>
        <div class="response form-inline">
          <input type="number" id="res-mins" class="form-control" value="00">
        </div>
      </div>
      <br>
  ...
  <script>
    ...
    function questionGenerator() {
      ...
      var fulltime = hour * 60 + minute;

      // calculate the rotation angles for the clock hands (in degrees).

      var minutehand = minute * 6;

      var hourhand = hour > 12 ? (hour - 12) * 30 + minute / 2 : hour * 30 + minute / 2;

      var quest = {
        q: { mins: minute, hrs: hour },
        deg: { mins: minutehand, hrs: hourhand }
      };
      var answer = { minutes: minute, hours: hour };
      // start copied code
      return [quest, answer];
    }
    ...
    function newQuestion() {
      ...
      $('.clock .hour-hand').css('transform', 'rotate(' + question[0].deg.hrs + 'deg)');
      $('.clock .minute-hand').css('transform', 'rotate(' + question[0].deg.mins + 'deg)');
    }
    ...
    function checkAns() {
      ...
      if (isCorrect) {
        ...
        wrong++;
        message.css('color', 'red').text('Sorry, that is not correct. ❌ The correct answer is: ' + question[1].hours + ':' + ("0" + question[1].minutes).slice(-2));
      }
      $('input').blur();
