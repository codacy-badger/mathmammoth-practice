  ...
  <div class="container">
    <div class="jumbotron" id="form" style="background-color: #a5eaff">
      ...
      <div class="custom-control custom-checkbox">
        ...
        <label for="2p1dwr" class="custom-control-label">2-digit + 1-digit, with regrouping (e.g. 45 + 8, 62 + 9)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2dpmo10" class="custom-control-input" checked>
        <label for="2dpmo10" class="custom-control-label">2-digit + multiple of 10 (e.g. 40 + 23, 55 + 30)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2p2dnr" class="custom-control-input">
        <label for="2p2dnr" class="custom-control-label">2-digit + 2-digit, no regrouping (e.g. 25 + 13, 61 + 38)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2p2dwr" class="custom-control-input">
        <label for="2p2dwr" class="custom-control-label">2-digit + 2-digit, with regrouping (e.g. 54 + 27, 38 + 28)</label>
      </div>
      <!-- subtraction opts --><hr>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2m1dnr" class="custom-control-input">
        <label for="2m1dnr" class="custom-control-label">2-digit &minus; 1-digit, no regrouping (e.g. 45 &minus; 3, 68 &minus; 5)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2m1dwr" class="custom-control-input">
        <label for="2m1dwr" class="custom-control-label">2-digit &minus; 1-digit, with regrouping (e.g. 45 &minus; 8, 63 &minus; 5)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2dmmo10" class="custom-control-input" checked>
        <label for="2dmmo10" class="custom-control-label">2-digit &minus; multiple of 10 (e.g. 37 &minus; 20, 97 &minus; 50)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2m2dnr" class="custom-control-input">
        <label for="2m2dnr" class="custom-control-label">2-digit &minus; 2-digit, no regrouping (e.g. 76 &minus; 22, 57 &minus; 35)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="2m2dwr" class="custom-control-input">
        <label for="2m2dwr" class="custom-control-label">2-digit &minus; 2-digit, with regrouping (e.g. 55 &minus; 36, 92 &minus; 37)</label>
      </div>
      <div class="custom-control custom-checkbox">
        <input type="checkbox" id="100m2d" class="custom-control-input">
        <label for="100m2d" class="custom-control-label">100 &minus; 2-digit  (e.g. 100 &minus; 33, 100 &minus; 58)</label>
      </div><!-- 13 lines -->
      <!-- start copied code -->
